...
class Ebizmarts_SagePaymentsPro_Model_EventObserver
{
    ...
    {
//        $groups = Mage::getSingleton('adminhtml/config_data')->getGroups();
        ...
        $website = is_null($o->getEvent()->getWebsite()) ? Mage::app()->getWebsite(true): $o->getEvent()->getWebsite();
        $store  = is_null($o->getEvent()->getStore()) ? Mage::app()->getWebsite(true)->getDefaultGroup()->getDefaultStoreId(): $o->getEvent()->getStore();
    ...
    public function newOrder(Varien_Event_Observer $o)
    {
        ...
        $transaction = Mage::getModel('ebizmarts_sagepaymentspro/transaction')->loadByOrderId($order->getIncrementId(),$order->getStoreId());
