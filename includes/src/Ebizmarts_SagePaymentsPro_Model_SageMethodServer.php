...
//        $tokenActive = $data->getTokenactive();
...
//        $rc = $api->reference($transaction,$payment,$amount,Ebizmarts_SagePaymentsPro_Model_Config::CODE_RELEASE);
...
//            $payment->setLastTransId($xml->PaymentResponses->PaymentResponseType->TransactionResponse->VANReference);
//        }
//        else {
