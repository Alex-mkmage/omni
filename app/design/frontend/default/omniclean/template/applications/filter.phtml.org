...
Animal Icon: Created by Francisca Arévalo
...
$productShortNames = array(
    ...
    '19-040' => 'Bead Ruptor 96',
    'OR4000-115' => 'Sonic Ruptor 4000',
    '18-000-115' => 'Sonic Ruptor 400'
);
$this->setProductShortNames($productShortNames);
?>
...
<script type="text/javascript">
    jQuery(function ($) {
        $('.tagItProduct').tagsInput({
            autocomplete_url: '<?php echo Mage::getUrl("application/application/products"); ?>',
            'height':'200px',
            'width':'100%'
        });
