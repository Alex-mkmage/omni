        ...
        <?php if(count($items) > 0): ?>
            <ul class="app-notes">
                <?php foreach ($items as $item): ?>
                    <li class="application <?php echo strtolower($item['sample_type']); ?>" data-application-id="<?php echo $item['application_id'] ?>" data-id="<?php echo $item['id'] ?>">
                        ...
                        <div class="header">
                            ...
                            <?php if($files->getSize()): ?>
                                <div class="pdf">
                                    ...
                                    <svg class="svg-pdf" version="1.1" id="Layer_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" fill="#ffffff" x="0px" y="0px" width="90%" height="90%" viewBox="0 0 76.5 89" style="enable-background:new 0 0 76.5 89;" xml:space="preserve">
                                        <g>
                                            <g>
                                                <path d="M20.6,38.5h-1.5V43h1.4c1.9,0,2.8-0.8,2.8-2.3S22.4,38.5,20.6,38.5z"></path>
                                                <path d="M0,0v89h76.5V28.5L47.9,0H0z M20.7,46.9h-1.4v4.6h-5.4V34.4H21c4.9,0,7.7,2.5,7.7,6.2C28.7,44.7,25.9,46.9,20.7,46.9zM37.8,51.6H31V34.4h7.1c6.2,0,9.7,3.4,9.7,8.5C47.9,48.1,44.3,51.6,37.8,51.6z M50.3,34.4h13.2v4.3h-7.8v2.5h6.1v4.3h-6.1v6.1h-5.3L50.3,34.4L50.3,34.4z"></path>
                                                <path d="M37.8,38.5h-1.3v8.9h1.6c2.7,0,4.3-1.3,4.3-4.4C42.4,39.8,41,38.5,37.8,38.5z"></path>
                                            </g>
                                        </g>
                                    </svg>
                                </div>
                        ...
                        <div class="info-wrapper">
                            <div class="app-info">
                                ...
                                <div class="goal">
                                    <span>Analyte:</span>
                                    <?php if(isset($item['analyte'])): ?>
                                        <p><?php echo $item['analyte'] ?></p>
                                    <?php else: ?>
                                        <p>Not available</p>
                                    <?php endif; ?>
                                </div>
                                <div class="description hidden">
                                    <p><?php echo $item['procedure'] ?></p>
                                </div>
            ...
            jQuery(function ($) {
                ...
                $('.application-toolbar').pagination({
                    ...
                    onPageClick: function(pageNumber, event){
                        var target = $('#application-list-results'),
        ...
        if(!featured.hasClass('hideFeatured')){
            ...
            function shorten(text, maxLength) {
                ...
                if (ret.length > maxLength) {
                    ret = ret.substr(0,maxLength-3) + '… <small>open application to see full description.</small>';
                }
                return ret;
            }
            item.each(function(index){
                ...
                if(pdf !== undefined || pdf !== null){
                    pdf = '<!-- Pdf Icon: Created by Graham Dragonborn Wilsdon --><svg version="1.1" id="Layer_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" fill="#ffffff" x="0px" y="0px" viewBox="0 0 76.5 89" style="enable-background:new 0 0 76.5 89;" xml:space="preserve"><g><g><path d="M20.6,38.5h-1.5V43h1.4c1.9,0,2.8-0.8,2.8-2.3S22.4,38.5,20.6,38.5z"></path><path d="M0,0v89h76.5V28.5L47.9,0H0z M20.7,46.9h-1.4v4.6h-5.4V34.4H21c4.9,0,7.7,2.5,7.7,6.2C28.7,44.7,25.9,46.9,20.7,46.9zM37.8,51.6H31V34.4h7.1c6.2,0,9.7,3.4,9.7,8.5C47.9,48.1,44.3,51.6,37.8,51.6z M50.3,34.4h13.2v4.3h-7.8v2.5h6.1v4.3h-6.1v6.1h-5.3L50.3,34.4L50.3,34.4z"></path><path d="M37.8,38.5h-1.3v8.9h1.6c2.7,0,4.3-1.3,4.3-4.4C42.4,39.8,41,38.5,37.8,38.5z"></path></g></g></svg>';
                }else{
                    pdf = '';
                }
                if(index === 0){
                    $(this).addClass('active');
                    var el = '<div class="featured-item active" data-id="'+dataId+'">';
                }else{
                    var el = '<div class="featured-item" data-id="'+dataId+'">';
                }
                    ...
                    el += '<div class="right-col col">';
                        ...
                        el += '<div class="inner-wrapper">';
                          el += '<div class="goal info"><strong>Analyte:</strong>';
                            el += goal;
                          el += '</div>';
                          el += '<div class="description info"><strong>Procedure:</strong>';
                            el += description;
                          el += '</div>';
                          ...
                          el += '<div class="view-note">';
                            el += '<a href="'+urlLink+'">Click here to open Protocol</a>';
                          el += '</div>';
