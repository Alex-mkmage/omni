...
class Ey_Protocol_Block_Adminhtml_Application_Edit_Tabs extends Mage_Adminhtml_Block_Widget_Tabs
{
    ...
    protected function _beforeToHtml()
    {
        $this->addTab('app_edit_general', array(
            ...
            'content'   => $this->getLayout()
                ->createBlock('ey_protocol/adminhtml_application_edit_tab_form')
                ->toHtml()
        ));
        ...
        $this->addTab('app_edit_file', array(
            ...
            'content'   => $this->getLayout()
                ->createBlock('ey_protocol/adminhtml_application_edit_tab_file')
                ->toHtml()
        ));
