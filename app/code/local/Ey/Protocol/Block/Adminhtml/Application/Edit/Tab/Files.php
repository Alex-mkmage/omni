...
class Ey_Protocol_Block_Adminhtml_Application_Edit_Tab_Files extends Mage_Adminhtml_Block_Widget_Grid
{
    ...
    protected function _prepareCollection() {
        $collection = Mage::getModel('ey_protocol/file')->getCollection();
    ...
    protected function _prepareColumns() {
        ...
        $this->addColumn('name', array(
            'header' => Mage::helper('ey_protocol')->__('Name'),
            'index' => 'name'
        ));
    ...
    public function getSelectedItem() {
        ...
        $collection = Mage::getModel('ey_protocol/fileapp')->getCollection()
