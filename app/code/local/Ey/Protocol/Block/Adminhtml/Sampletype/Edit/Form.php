...
class Ey_Protocol_Block_Adminhtml_Sampletype_Edit_Form extends Mage_Adminhtml_Block_Widget_Form
{
    /**
     * @return $this
     */
    ...
    protected function _getApplication()
    {
        if (!$this->hasData('sampletype')) {
            ...
            if (!$type instanceof Ey_Protocol_Model_Sampletype) {
                $type = Mage::getModel(
                    'ey_protocol/sampletype'
                );
            }
