...
$table->setName($this->getTable('ey_applications/application'));
$table->addColumn(
    'entity_id',
...
$table2->setName($this->getTable('ey_applications/product'));
$table2->addColumn(
    'entity_id',
    Varien_Db_Ddl_Table::TYPE_INTEGER,
    10,
...
$table3->setName($this->getTable('ey_applications/tag'));
$table3->addColumn(
    'entity_id',
    Varien_Db_Ddl_Table::TYPE_INTEGER,
    10,
...
$table4->setName($this->getTable('ey_applications/sampletype'));
$table4->addColumn(
    'entity_id',
    Varien_Db_Ddl_Table::TYPE_INTEGER,
    10,
...
$table5->setName($this->getTable('ey_applications/type'));
$table5->addColumn(
    'entity_id',
    Varien_Db_Ddl_Table::TYPE_INTEGER,
    10,
