...
class Ey_Applications_Adminhtml_SampletypeController extends Mage_Adminhtml_Controller_Action
{
    public function indexAction()
    {
        $block = $this->getLayout()
            ->createBlock('ey_applications/adminhtml_sampletype');
    ...
    {
        $application = Mage::getModel('ey_applications/sampletype');
        ...
        $editBlock = $this->getLayout()->createBlock(
            'ey_applications/adminhtml_sampletype_edit'
        );
    ...
    {
        $article = Mage::getModel('ey_applications/sampletype');
        ...
        switch ($actionName) {
            ...
            default:
                ...
                $isAllowed = $adminSession
                    ->isAllowed('ey_applications/sampletype');
                break;
        }
