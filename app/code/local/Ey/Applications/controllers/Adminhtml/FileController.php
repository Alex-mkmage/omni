...
class Ey_Applications_Adminhtml_FileController extends Mage_Adminhtml_Controller_Action
{
    public function indexAction()
    {
        $block = $this->getLayout()
            ->createBlock('ey_applications/adminhtml_file');
    ...
    public function editAction()
    {
        ...
        $editBlock = $this->getLayout()->createBlock(
            'ey_applications/adminhtml_file_edit'
        );
    ...
    {
        $article = Mage::getModel('ey_applications/file');
        ...
        switch ($actionName) {
            ...
            default:
                ...
                $isAllowed = $adminSession
                    ->isAllowed('ey_applications/file');
                break;
        }
