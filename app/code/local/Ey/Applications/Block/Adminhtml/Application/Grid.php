...
class Ey_Applications_Block_Adminhtml_Application_Grid extends Mage_Adminhtml_Block_Widget_Grid
{
    ...
    protected function _prepareCollection()
    {
        $collection = Mage::getResourceModel(
            'ey_applications/application_collection'
        );
    ...
    {
        return Mage::helper('ey_applications');
    }
