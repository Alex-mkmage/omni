...
class Ey_Applications_Block_Adminhtml_File_Edit_Form extends Mage_Adminhtml_Block_Widget_Form
{
    /**
     * @return $this
     */
    ...
    protected function _getFile()
    {
        if (!$this->hasData('file')) {
            ...
            if (!$type instanceof Ey_Applications_Model_File) {
                $type = Mage::getModel(
                    'ey_applications/file'
                );
            }
