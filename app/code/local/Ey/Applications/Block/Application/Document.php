...
class Ey_Applications_Block_Application_Document extends Ey_Applications_Block_Application
{
    /**
     * @var Ey_Applications_Model_Application
     */
    protected $_document;
    ...
    {
        parent::_construct();
        $this->maxDownloadTimes = $this->helper('ey_applications')->getDownloadLimit();
    }
    ...
    protected function _prepareLayout()
    {
        ...
        if(!$document = Mage::registry('current_document')){
            if($id = $this->getRequest()->getParam('id')){
                $document = Mage::getModel('ey_applications/application')->load($id);
                Mage::register('current_document', $document);
                $this->_document = $document;
            }
        }
        Mage::dispatchEvent('application_render_before', array(
    ...
    /**
     * @return Ey_Applications_Model_Application
     */
    ...
    {
        return Mage::getBaseUrl().'application/application/logger';
    }
