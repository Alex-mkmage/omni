...
<ul class="megamenu">
<li><a class="box" href="{{store url="industries/parmaceutical-life-science.html"}}">Parmaceutical &amp; Life Science</a>
<ul>
<li><a class="box" href="{{store url="industries/proteomics.html"}}">Proteomics</a></li>
</ul>
</li>
<li><a class="box" href="{{store url="industries/food.html"}}">Food</a>
<ul>
<li><a class="box" href="{{store url="industries/gmo.html"}}">GMO</a></li>
<li><a class="box" href="{{store url="industries/pesticides.html"}}">Pesticides</a></li>
<li><a class="box" href="{{store url="industries/production.html"}}">Production</a></li>
</ul>
</li>
<li><a class="box" href="{{store url="industries/forensic.html"}}">Forensic</a></li>
<li><a class="box" href="{{store url="industries/environmental.html"}}">Environmental</a></li>
</ul>
</div>
</div>
EOF;
