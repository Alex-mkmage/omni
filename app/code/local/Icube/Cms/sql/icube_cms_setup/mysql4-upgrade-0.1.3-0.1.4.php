...
<ul>
<li class="first"><a>Corporate</a></li>
<li class="active"><a href="{{store_url='careers'}}">Careers</a></li>
<li><a href="{{store_url='faqs'}}">FAQS</a></li>
<li><a href="{{store_url='privacy-policy'}}">Privacy Policy</a></li>
<li class="last"><a href="{{store_url='contacts'}}">Contact Us</a></li>
</ul>
