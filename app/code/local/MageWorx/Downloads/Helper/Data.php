...
//       	$filter->addFilter(new Zend_Filter_StripTags());
    ...
    public function getFileCategoriesText($filesCatIds = array(""))
    {
        $filesCatText = '';
        foreach($filesCatIds as $filesCatId) {
            $modelCat = Mage::getModel('downloads/categories')->load($filesCatId);
            $filesCatText .= $modelCat->getTitle().', ';
        }
        $filesCatText = $filesCatText==''?'':substr($filesCatText, 0, -2);
        return $filesCatText;
    }
}