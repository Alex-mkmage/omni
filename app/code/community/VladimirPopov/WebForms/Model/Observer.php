...
class VladimirPopov_WebForms_Model_Observer
{
    ...
    public function customerDeleteBefore($observer){
        if(Mage::getStoreConfig('webforms/gdpr/purge_data_on_account_delete')){
            $customer = $observer->getCustomer();
            $collection = Mage::getModel('webforms/results')->getCollection()->addFilter('customer_id', $customer->getId());
