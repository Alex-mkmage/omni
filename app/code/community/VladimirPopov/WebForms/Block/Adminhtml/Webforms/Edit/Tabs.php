...
class VladimirPopov_WebForms_Block_Adminhtml_WebForms_Edit_Tabs extends Mage_Adminhtml_Block_Widget_Tabs {
	...
	protected function _beforeToHtml() {
		...
		$this->addTab('form_gdpr', array(
			'label' => Mage::helper('webforms')->__('GDPR Settings'),
			'title' => Mage::helper('webforms')->__('GDPR Settings'),
			'content' => $this->getLayout()->createBlock('webforms/adminhtml_webforms_edit_tab_gdpr')->toHtml(),
		));
